...
const RestaurantDetails = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
      ...
      <img src={restaurant.image} alt={restaurant.name} className="w-full h-[250px] rounded-md mb-4" />
        ...
        <div>
          <div className="mb-4">
            ...
            <div className="flex items-center">
              <Rate disabled defaultValue={restaurant.ratings} style={{ color: "#FFC107" }} />
      ...
      <div className="mt-4 flex items-center">
        ...
        <div className="ml-4 flex items-center">
          ...
          <Input value={restaurant.openTime}  style={{ width: '100px', marginRight: '10px' }} />
