...
import { useChangeOwnerStatusMutation } from "../../../redux/features/auth/authApi";
import { useSelector } from "react-redux";
import { ErrorToast } from "../../../helper/ValidationHelper";


const ChangeOwnerStatusModal = ({ userId, status }) => {
  const [modalOpen, setModalOpen] = useState(false);
  const [ changeOwnerStatus, { isLoading, isSuccess }] = useChangeOwnerStatusMutation();
...
export default ChangeOwnerStatusModal;
